...
// all avaible end points
// http://localhost:3000/
//http://localhost:3000/verify-phone
//http://localhost:3000/verify-phone?signin=true
//http://localhost:3000/verify-phone?signup=true
//http://localhost:3000/verify-phone?link=true
//localhost:3000/login?link=true
      ...
      <main className={styles.main}>
        ...
        <div className={styles.grid}>
          ...
          >
            ...
            <p>
              Deliver dynamic, personalized content with the lightweight Edge Runtime.
            </p>
          </a>
          <Logout />
        </div>
